...
export default function FleetManagementPage() {
  ...
  const getStatusColor = (status: RobotStatus) => {
    switch (status) {
      ...
      default: return 'text-gray-500 bg-gray-500/10 border-gray-900';
    }
  };
  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-black uppercase tracking-widest text-white">Fleet Management</h1>
          <p className="text-gray-400 mt-1 text-sm tracking-widest uppercase">Monitor and control robot operations</p>
        </div>
        <div className="flex gap-4">
          <div className="bg-black border border-gray-800 px-4 py-2 rounded-lg flex gap-4 text-xs font-bold uppercase tracking-widest">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1">
        ...
        <div className="col-span-2 grid grid-cols-2 gap-4">
          {robots.map(robot => (
            <div key={robot.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-gray-600 transition-colors flex flex-col">
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xl bg-black border border-gray-800`}>
                    🤖
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-1 font-mono font-bold text-sm bg-black px-2 py-1 rounded border border-gray-800">
                  {getBatteryIcon(robot.battery)} {robot.battery}%
                </div>
              </div>
              
              <div className="bg-black border border-gray-800 p-3 rounded mt-auto">
                <div className="text-xs text-gray-500 font-bold uppercase tracking-widest mb-1">Current State</div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-4">
                <button className="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 rounded text-xs uppercase tracking-widest transition-colors">
                  Assign Task
                </button>
                <button className="bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 rounded text-xs uppercase tracking-widest transition-colors">
                  Return to Base
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-black relative flex items-center justify-center">
             ...
             <div className="absolute bottom-4 left-4 right-4 bg-black/80 backdrop-blur border border-gray-800 p-3 rounded text-center">
               <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-2">Select a robot to view camera feed</p>
